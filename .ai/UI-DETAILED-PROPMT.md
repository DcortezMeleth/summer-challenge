...
6. Type Definitions:
<type_definitions>
@app/lib/summer_challenge/model/types.ex 
</type_definitions>
...
1. For each input section (PRD, User Stories, Type Definitions, Tech Stack):
...
5. Identify required DTOs and custom types for each view component. Explain these new types in detail, breaking down their fields and associated types.

  ...
  describe "get_milestone_achievers/1" do
    ...
    test "returns users who reached 40-hour milestone", %{challenge: challenge} do
      ...
      Repo.insert!(%Activity{
        ...
        distance_m: 100_000,
        # 50 hours
        moving_time_s: 50 * 60 * 60,
        elev_gain_m: 1000,
        excluded: false
      })

      {:ok, %{achievers: achievers}} =
        Milestones.get_milestone_achievers(challenge_id: challenge.id)
    ...
    test "aggregates multiple activities to reach threshold", %{challenge: challenge} do
      ...
      Repo.insert!(%Activity{
        ...
        strava_id: 1,
        sport_type: "Run",
        start_at: DateTime.add(Clock.utc_now(), -10, :day),
        distance_m: 20_000,
        # 15 hours
      ...
      Repo.insert!(%Activity{
        ...
        strava_id: 3,
        sport_type: "Run",
        start_at: DateTime.add(Clock.utc_now(), -2, :day),
        distance_m: 10_000,
        # 6 hours
      ...
      # 41 hours total
      assert hd(achievers).total_moving_time_s == 41 * 60 * 60
    end
    ...
    test "only counts activities from the specified challenge", %{challenge: challenge} do
      ...
      Repo.insert!(%Activity{
        ...
        strava_id: 2,
        sport_type: "Run",
        start_at: DateTime.add(Clock.utc_now(), -45, :day),
        distance_m: 20_000,
        moving_time_s: 20 * 60 * 60,
        elev_gain_m: 200,
        excluded: false
    ...
    test "includes team name in results", %{challenge: challenge} do
      ...
      # Create a team
      team =
        Repo.insert!(%SummerChallenge.Model.Team{
          name: "Fast Runners",
